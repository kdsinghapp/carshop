enum ScreenNameEnum {
  ...
  OvertimeEmploye="OvertimeEmploye",
  EmployeeTasks="EmployeeTasks",
  TotallyTask="TotallyTask",
  ...
  ShirftSchedule='ShirftSchedule',
  AddNewShiftScreen='AddNewShiftScreen',
  OverTime='OverTime',
  AddOvertimeScreen='AddOvertimeScreen',
  HolidayListScreen='HolidayListScreen',
  AddHolidayForm='AddHolidayForm',
  RequestLeave='RequestLeave',
  AddLeaveRequestForm='AddLeaveRequestForm',
