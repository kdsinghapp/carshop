...
const EmployeeList: React.FC = ({ navigation }: any) => {
  ...
  seconfImg={true}
  navigation={navigation}  title='Employee List'  style={{marginTop:-10}} />
...
<View style={{flex:1,marginTop:20}} >
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          onPress={()=>{
            navigation.navigate(ScreenNameEnum.EmployeeProfile)
          }}
          style={styles.employeeCard}>
            ...
            <View style={styles.employeeInfo}>
              ...
              <Text style={styles.overtimeText}>Overtime Hours: {item.overtime}</Text>
              {/* Progress Bar */}
