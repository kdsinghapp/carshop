...
const HrProjects: React.FC = ({ navigation }: any) => {
    ...
    return (
        <View style={styles.container}>
                        ...
                        <View style={styles.card}>
                            ...
                            <View style={styles.row}>
                                ...
                                <View>
                                    ...
                                    <Text style={styles.priority}>20 March 2025</Text>
                                </View>
                                <TouchableOpacity>
                                    <Icon
                                        source={icon.redtras}
                            ...
                            <View style={styles.row}>
                                ...
                                <View >
                                    ...
                                    <Text style={styles.deadline}>Active</Text>
                                </View>
                                <TouchableOpacity>
                                    <Icon
                                        source={icon.eyes}
                            ...
                            {/* Progress Bar */}
                            <Text style={[styles.label, { marginVertical: 10 }]}>Progress</Text>
            ...
            <TouchableOpacity 
      onPress={()=>{
        navigation.navigate(ScreenNameEnum.AddProjectForm)
      }}
    style={{
      position:'absolute',
      bottom:20,right:15
