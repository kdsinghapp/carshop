    ...
    const ShirftSchedule: React.FC = ({ navigation }: any) => {
        ...
        return (
            <View style={styles.container}>
                <StatusBar
                    backgroundColor={'#fff'}
                />
                <CustomHeader title='Shift & Schedule'
                    seconfImg={true}
                    style={{ marginTop: -15 }}
                            ...
                            <View style={styles.card}>
                                ...
                                <View style={styles.row}>
                                    <View>
                                        ...
                                        <Text style={styles.taskText}>Emersan Vaccoro</Text>
                                    </View>
                                    <View>
    
                                        <Text style={styles.label}>Status</Text>
                                        <Text style={styles.taskText}>Accountant</Text>
                                    </View>
                                    <TouchableOpacity>
                                        <Icon
                                            source={icon.redtras}
                                ...
                                <View style={styles.row}>
                                    <View>
                                        <Text style={styles.label}>User Available Timings</Text>
                                        <Text style={styles.taskText}>25-03-20-10:00 AM -11:00AM</Text>
                                    </View>
                ...
                <TouchableOpacity
                    onPress={() => {
                        navigation.navigate(ScreenNameEnum.AddNewShiftScreen)
                    }}
                    style={{
                        position: 'absolute',
                        bottom: 20, right: 15
