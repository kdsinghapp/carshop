...
const HolidayListScreen: React.FC = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <CustomHeader
                seconfImg={true}
                navigation={navigation} title="Holiday List" showSkip={false} style={{ marginTop: -20 }} />
            ...
            <TouchableOpacity
                onPress={() => {
                    navigation.navigate(ScreenNameEnum.AddHolidayForm)
                }}
                style={{
                    position: 'absolute',
                    bottom: 20, right: 15
